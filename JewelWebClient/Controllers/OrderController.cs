...
namespace WebMvc.Controllers
{
    public class OrderController : Controller
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Create(JewelWebClient.Models.Order frmOrder)
        {
                var user = _identitySvc.Get(HttpContext.User);
                var order = frmOrder;
                order.BuyerName = user.Email;
                ...
                var chargeOptions = new ChargeCreateOptions
                {
                    ...
                    Description = $"Jewelsoncontainer Order payment {order.BuyerName}",
                    ReceiptEmail = order.BuyerName
                };
